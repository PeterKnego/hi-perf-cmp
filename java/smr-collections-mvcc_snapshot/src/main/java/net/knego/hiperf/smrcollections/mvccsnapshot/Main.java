package net.knego.hiperf.smrcollections.mvccsnapshot;
...
/** smr-collections/mvcc_snapshot (Java): time serialize + restore of a steady CoW book. */
public final class Main {
    private static final String EXPERIMENT = "mvcc_snapshot";
    ...
    public static void main(String[] args) {
        try {
            ...
            for (int i = 0; i < cfg.warmup(); i++) {
                int len = s.encodeRoot(book.capture());
                CowSnapshotter.restoreCow(s.backing(), len, cfg);
            }
