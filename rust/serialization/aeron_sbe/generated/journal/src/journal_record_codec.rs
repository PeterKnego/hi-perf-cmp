...
pub use decoder::JournalRecordDecoder;
pub use encoder::JournalRecordEncoder;
...
pub mod encoder {
    ...
    pub struct JournalRecordEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for JournalRecordEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for JournalRecordEncoder<'a> {
        #[inline]
    ...
    impl<'a> JournalRecordEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn event_type(&mut self, value: event_type::EventType) -> &mut Self {
    ...
    impl<'a, P> EntriesEncoder<P> where P: Encoder<'a> + Default {
        ...
        /// - version: 0
        #[inline]
        pub fn entry_term_id(&mut self, value: i64) -> &mut Self {
            let offset = self.offset;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// primitive field 'entryIndex'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn entry_index(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 8;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// primitive field 'entryTimestamp'
        /// - min value: -9223372036854775807
        /// - max value: 9223372036854775807
        /// - null value: -9223372036854775808_i64
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn entry_timestamp(&mut self, value: i64) -> &mut Self {
            let offset = self.offset + 16;
            self.get_buf_mut().put_i64_at(offset, value);
            self
        }

        /// primitive field 'commandKey'
        /// - min value: -2147483647
        /// - max value: 2147483647
        /// - null value: -2147483648_i32
        /// - characterEncoding: null
        ...
        /// - version: 0
        #[inline]
        pub fn command_key(&mut self, value: i32) -> &mut Self {
            let offset = self.offset + 24;
            self.get_buf_mut().put_i32_at(offset, value);
            self
        }
...
pub mod decoder {
    ...
    pub struct JournalRecordDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for JournalRecordDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for JournalRecordDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for JournalRecordDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> JournalRecordDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn event_type(&self) -> event_type::EventType {
        ...
        pub fn flags(&self) -> u8 {
            self.get_buf().get_u8_at(self.offset + 49)
        }
